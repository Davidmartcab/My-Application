...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        retos.add("Lame el cuello del 2º jugador de la izquierda")
        ...
        retos.add("Chupa el dedo del jugador de la derecha sensualmente durante 30 segundo")
        retos.add("Chupa el dedo del jugador de la izquierda sensualmente durante 30 segundo")
        retos.add("Chupa el dedo del 2º jugador de la derecha sensualmente durante 30 segundo")
        retos.add("Chupa el dedo del 2º jugador de la izquierda sensualmente durante 30 segundo")
        retos.add("Chupa el dedo del jugador frente a tí sensualmente durante 30 segundo, si sois impares, a los dos")
        retos.add("Chupa el dedo de los jugadores en diagonal a tí sensualmente durante 30 segundo")
        ...
        retos.add("Tumbate en la entrepierta del 2º jugador de la izquierda durante una ronda")
        ...
        retos.add("Perrea al 2º jugador de la derecha")
        retos.add("Perrea al 2º jugador de la izquierda")
        retos.add("Perrea al jugador frente a tí, si sois impares, elige el grupo cual de los dos")
        retos.add("Perrea al jugador en diagonal a tí, elige el grupo cual de los dos")
        ...
        retos.add("Besa la parte del cuerpo que eliga el grupo al 2º jugador de la derecha")
        retos.add("Besa la parte del cuerpo que eliga el grupo al 2º jugador de la izquierda")
        ...
        retos.add("Besa la parte del cuerpo que eliga el grupo al jugador en diagonal a tí, elige el grupo cual de los dos")
        ...
        retos.add("Lame la espalda del 2º jugador de la izquierda de forma sendual por debajo de la ropa")
        ...
        retos.add("Haz un recorrico de besos sensuales desde el abdomen hasta la entrepierna al jugador de la derecha")
        retos.add("Haz un recorrico de besos sensuales desde el abdomen hasta la entrepierna al jugador de la izquierda")
        retos.add("Haz un recorrico de besos sensuales desde el abdomen hasta la entrepierna al 2º jugador de la derecha")
        retos.add("Haz un recorrico de besos sensuales desde el abdomen hasta la entrepierna al 2º jugador de la izquierda")
        retos.add("Haz un recorrico de besos sensuales desde el abdomen hasta la entrepierna al jugador frente a tí, si sois impares, elige el grupo cual de los dos")
        retos.add("Haz un recorrico de besos sensuales desde el abdomen hasta la entrepierna al jugador en diagonal a tí, elige el grupo cual de los dos")
